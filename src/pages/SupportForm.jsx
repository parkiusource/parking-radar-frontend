            ...
            <Card className="bg-white rounded-xl shadow-md overflow-hidden">
              <CardContent className="p-0">
                ...
                {submitStatus === 'success' && (
                  <motion.div
                    className="flex items-center p-4 mx-4 sm:mx-6 mt-5 text-sm rounded-lg bg-green-50 text-green-800 border border-green-200"
                ...
                {submitStatus === 'error' && (
                  <motion.div
                    className="flex items-center p-4 mx-4 sm:mx-6 mt-5 text-sm rounded-lg bg-red-50 text-red-800 border border-red-200"
                    initial={{ opacity: 0, height: 0 }}
                    animate={{ opacity: 1, height: 'auto' }}
                  >
