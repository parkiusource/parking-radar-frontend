...
import { CheckCircle, Send, AlertCircle, HeadphonesIcon, MailIcon, PhoneIcon } from 'lucide-react';
...
const SupportForm = () => {
  ...
  return (
    <>
      ...
      <main className="bg-secondary-50 py-12 md:py-16 min-h-[calc(100vh-64px)]">
        {/* Hero section */}
        <div className="bg-primary-700 py-8 mb-12">
                  ...
                  <div className="p-6">
                    <ul className="space-y-4">
                      <li className="flex items-start gap-3">
                        <MailIcon className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-gray-700">Correo electrónico</p>
                          <a href="mailto:soporte@parkiu.com" className="text-primary-600 hover:underline">
                            soporte@parkiu.com
                          </a>
                        </div>
                      </li>
                      ...
                      <li className="flex items-start gap-3">
                        <PhoneIcon className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                        <div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200">
                      <h4 className="font-medium text-gray-800 mb-3">Preguntas frecuentes</h4>
                      <ul className="space-y-2">
                        <li>
                          <a href="#" className="text-primary-600 hover:underline text-sm">
                            ¿Cómo reservo un parqueadero?
                          </a>
                        </li>
                        <li>
                          <a href="#" className="text-primary-600 hover:underline text-sm">
