          ...
          <div className="text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center text-justify mb-6">
              <p className="md:order-2 md:ml-4">
                El propósito principal del proyecto es diseñar un sistema que
                identifique parqueaderos en zonas de interés dentro de Bogotá,
                mejorando la experiencia de los usuarios al buscar
                estacionamientos en áreas de alta afluencia, como centros
                comerciales y zonas de entretenimiento.
              </p>
              <img
                src={iconGoal}
                alt="Icono de meta"
            ...
            <div className="flex flex-col md:flex-row justify-center items-center text-justify mb-6">
              ...
              />
              <p>
                La plataforma ofrece acceso a información en tiempo real sobre
                la disponibilidad de espacios de estacionamiento. Esto permite a
                los conductores dirigirse rápidamente a lugares cercanos y
                accesibles, ayudando a reducir el tráfico y apoyando el
            ...
            <div className="flex flex-col md:flex-row justify-center items-center text-justify mb-6">
              <p className="md:order-2 md:ml-4">
                ...
                IoT que se instala en los parqueaderos. Este dispositivo envía
                información en tiempo real a nuestro servicio, que gestiona los
                datos de forma eficiente. Los usuarios pueden consultar la
                disponibilidad de los espacios a través de esta página web.
              </p>
              <img
                src={iconSmartCar}
            ...
            <div className="flex flex-col md:flex-row justify-center items-center text-justify mb-6">
              ...
              <p>
                ...
                desarrollo del proyecto y esperamos que nuestra solución sea
                útil para todos. Nos emociona la oportunidad de mejorar la
                experiencia de estacionamiento en Bogotá y confiamos en que esta
                herramienta facilite la búsqueda de espacios disponibles.
              </p>
            </div>
